           ...
           <!--menu horizontal termina-->
                ...
                <div class="contenedor d-flex flex-column align-items-center  justify-content-center">
                        <form action="InsertaConsulta.php" method="post">
                                ...
                                <div class="mb-3">
                                    <label for="disabledTextInput" class="form-label">Cédula Paciente</label>
                                    <input type="text" id="user_id" class="form-control" name="cedula_id" placeholder="Cédula Paciente">
                                </div>
                                <div class="mb-3">
                                ...
                                <button type="submit" class="btn btn-primary">Generar</button>
                                    ...
                                    <div id="emailHelp" class="form-text">No compartimos información con terceros</div>
                                    <!--Termina formulario-->
