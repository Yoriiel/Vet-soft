    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
           ...
           <!--menu horizontal termina-->
                ...
                <div class="contenedor d-flex text-align-center flex-column align-items-center justify-content-center">
                    <form method="post" action="insertaPaciente.php">
                        <legend>Formulario para Ingreso de Nuevo Paciente</legend>
                        ...
                        <div class="form-row justify-content-center">
                            <div class="col-md-6 mb-3 text-center">
                                <button type="submit" class="btn btn-primary">Ingresar Nuevo Paciente</button>
                            </div>
                        </div>
                    </form>
